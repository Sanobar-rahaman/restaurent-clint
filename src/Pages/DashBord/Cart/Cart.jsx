        ...
        <div>
            ...
            <div className="overflow-x-auto">
                <table className="table">
                    ...
                    <tbody>
                        {
                            cart.map((item, idx) => <tr key={item.Cart_id}>
                                <th >
                                    {idx + 1}
                                </th>
                                <td>
                                ...
                                <td>${item.price}</td>
                                <th>
                                    <button onClick={() => handleDelete(item._id)} className="btn btn-ghost btn-xs text-3xl"><FaTrash className=" text-red-400"></FaTrash> </button>
                                </th>
                            </tr>)
                        }
